...
public class ExplainFrame_3 extends JFrame{
	
	private Image screenImage;
	private Graphics screenGraphic;
	
	private Image explainFrame = new ImageIcon(Main.class.getResource("../images/explainFrame_3.png")).getImage();	//배경 이미지
