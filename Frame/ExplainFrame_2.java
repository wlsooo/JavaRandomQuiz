...
public class ExplainFrame_2 extends JFrame{
	
	private Image screenImage;
	private Graphics screenGraphic;
	
	private Image explainFrame = new ImageIcon(Main.class.getResource("../images/explainFrame_2.png")).getImage();	//배경 이미지
	...
	public ExplainFrame_2() {	//이게 생성자 메서드...?
		...
		//nextButton
		nextButton.setBounds(1160,600,80,80);					//exit버튼
		nextButton.setBorderPainted(false);					//아래 3줄은 아이콘의 배경을 제거
